    ...
    <section className="w-full bg-white px-4 py-20 md:px-6 md:py-28">
      <div className="mx-auto w-full max-w-[860px]">
        ...
        <div className="mb-14 text-center">
          ...
          <p className="mx-auto mt-5 max-w-[560px] text-base leading-relaxed text-neutral-500 md:text-lg">
        ...
        <div className="flex flex-col gap-5">
          ...
          {/* Block 01 */}
          <div className="group flex flex-col items-start gap-6 rounded-[2rem] border border-neutral-200 bg-white p-8 shadow-sm transition-all hover:shadow-md md:flex-row md:items-center md:gap-10 md:p-10">
        ...
        <div className="mt-12 text-center">
          <button
            ...
            className="group inline-flex cursor-pointer items-center gap-2 rounded-full border border-neutral-200 bg-neutral-50 px-7 py-3.5 text-sm font-bold text-neutral-600 transition-all hover:bg-neutral-900 hover:text-white"
          >
