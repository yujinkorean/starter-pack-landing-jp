        ...
        <div className="rounded-[3rem] bg-neutral-50 border border-neutral-100 px-6 py-16 md:px-12 md:py-24 shadow-inner">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {reviews.map((r, idx) => (
              <div
                key={idx}
                className="group relative flex h-full flex-col rounded-[2.5rem] border border-neutral-200/60 bg-white p-8 shadow-[0_15px_40px_-15px_rgba(0,0,0,0.06)] transition-[opacity,box-shadow] duration-300 md:hover:-translate-y-2 hover:shadow-[0_30px_60px_-20px_rgba(0,0,0,0.12)]"
              >
