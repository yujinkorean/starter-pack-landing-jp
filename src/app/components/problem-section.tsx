export function ProblemSection() {
  ...
  return (
    <section className="w-full bg-neutral-900 px-5 py-16 text-white md:px-6 md:py-28">
      <div className="mx-auto max-w-[900px]">
        <div className="text-center">
          <p className="mb-3 text-xs font-semibold tracking-[0.25em] text-white/40 uppercase">
            Does this sound familiar?
          </p>
          <h2 className="text-[28px] font-extrabold leading-[1.35] tracking-tight md:text-5xl">
            こんな経験、ありませんか？
          </h2>
          <p className="mx-auto mt-4 max-w-[600px] text-[15px] leading-[1.85] text-white/60 md:text-lg">
        ...
        <div className="mx-auto mt-10 grid max-w-[760px] grid-cols-1 gap-4 md:grid-cols-2">
          {problems.map((p) => (
            <div
              key={p.text}
              className="flex items-start gap-4 rounded-2xl border border-white/10 bg-white/5 p-5 md:p-6"
            >
              <span className="mt-0.5 text-2xl shrink-0">{p.emoji}</span>
              <p className="text-[15px] font-semibold leading-relaxed text-white md:text-lg">
                {p.text}
              </p>
            </div>
          ))}
        ...
        <div className="mx-auto mt-14 max-w-[600px] space-y-6 text-center">
          <p className="text-[17px] leading-[1.85] text-white/75 md:text-xl">
