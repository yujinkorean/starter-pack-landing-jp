...
const faqs = [
  ...
  {
    question: "TOPIK5・6級を目指していますが、このプログラムは使えますか？",
    answer: "はい、コーチングプランであれば対応可能です。メインテキストは入門〜初中級向けですが、コーチングはあなたの現在のレベルと目標（TOPIK5・6級など）に合わせて個別プランを設計します。韓国の入試家庭教師としての指導経験を活かした、試験特化サポートが可能です。まずはLINEで無料体験版を受け取り、ご相談ください。",
  },
  {
